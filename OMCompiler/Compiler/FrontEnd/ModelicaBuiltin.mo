...
function oms_addTLMBus
  ...
  input oms_tlm_interpolation_t interpolation;
  output Integer status;
external "builtin";
annotation(preferredView="text");
end oms_addTLMBus;
...
/*
function oms_addBus " Adds a bus."
  input String cref;
  output Integer status;
external "builtin";
annotation(preferredView="text");
...
function oms_addConnection "adds a connection between FMUS "
  input String crefA;
  input String crefB;
  output Integer status;
external "builtin";
...
function oms_addConnector
  input String cref;
  input oms_causality causality;
  input oms_signal_type signaltype;
  output Integer status;
  external "builtin";
annotation(preferredView="text");
end oms_addConnector;
...
function oms_addSubModel "add a new submodel to system "
  input String cref;
  input String fmuPath;
  output Integer status;
external "builtin";
...
function oms_addSystem "add a new system "
  input String cref;
  input oms_system systype;
  output Integer status;
external "builtin";
annotation(preferredView="text");
end oms_addSystem;
...
function oms_newModel " Adds a new model"
  input String cref;
  output Integer status;
external "builtin";
annotation(preferredView="text");
...
function oms_setTempDirectory " set a temp directory "
  input String newTempDir;
  output Integer status;
external "builtin";
annotation(preferredView="text");
...
function oms_setResultFile "sets the resultfile defined by user "
  input String cref;
  input String filename;
  input Integer bufferSize;
  output Integer status;
...
function oms_setReal "sets the real value  of variable"
  input String cref;
  input Real value;
  output Integer status;
external "builtin";
...
function oms_setRealInputDerivative "sets the real input derivative"
  input String cref;
  input Real value;
  output Integer status;
external "builtin";
...
function oms_setStartTime "sets the startTime"
  input String cref;
  input Real value;
  output Integer status;
external "builtin";
...
function oms_setStopTime "sets the stopTime"
  input String cref;
  input Real value;
  output Integer status;
external "builtin";
...
function oms_setFixedStepSize "sets the stepsize"
  input String cref;
  input Real stepSize;
  output Integer status;
external "builtin";
...
function oms_setCommandLineOption "sets command line options"
  input String cref;
  output Integer status;
  external "builtin";
annotation(preferredView="text");
